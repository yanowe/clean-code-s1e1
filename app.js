...
var createNewTaskElement=function(taskString){
    ...
    label.className='task taskLabel';

    //Each elements, needs appending
    checkBox.type="checkbox";
    checkBox.className="checkbox";
    editInput.type="text";
    editInput.className="task taskInput";
...
//select ListItems children
    ...
    var editButton=taskListItem.querySelector("button.editBtn");
    var deleteButton=taskListItem.querySelector("button.deleteBtn");
